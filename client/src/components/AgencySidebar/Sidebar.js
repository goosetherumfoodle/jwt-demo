...
import ContactBRM from '../../views/ContactBRM';
        ...
        return (
            <div className="sidebar">
                <nav className="sidebar-nav">
                    <Nav>
                        {navList(nav.items)}
                        <ContactBRM className="nav-link nav-dropdown-toggle" toggle={this.props.toggle} contactModal={this.props.contactModal}/>
                    </Nav>
                </nav>
                <SidebarMinimizer />
            </div>
