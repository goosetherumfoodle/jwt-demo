...
Built using CoreUI components.
Documentation:
http://coreui.io/docs/getting-started/introduction/
See demo to view examples: http://coreui.io/demo/React_Demo/#/dashboard
See code from demo:
https://github.com/mrholek/CoreUI-Free-Bootstrap-Admin-Template/tree/master/React_Full_Project

You will want to use the code from the demo as a reference to build your custom components.
